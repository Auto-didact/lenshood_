...
export default class ProductDetails extends Component {
  constructor(props) {
    ...
    this.handleGearSubSubcategoryChange = this.handleGearSubSubcategoryChange.bind(this);
  ...
  render() {
    ...
    return (
      <>
        ...
        {/* Gear Sub-Category */}
        {this.state.listingCategories.gearSubcategory[this.state.activeGearCategory] ? (
          <Field
          ...
          >
            {this.state.listingCategories.gearSubcategory[this.state.activeGearCategory].map((category, idx) => (
              <Select.Option key={idx} value={category}>
                {category}
              </Select.Option>
            ))}
        ...
        {this.state.listingCategories.gearSubSubcategory[this.state.activeGearSubcategories] ? (
          <>
            {this.state.listingCategories.gearSubSubcategory[this.state.activeGearSubcategories].some(
              item => item == 'Standard/Zoom Lens' || item == 'Wide angle/Fish eye Lens'
            ) ? (
              <p>
                <strong>Note: </strong>
                <ul>
            ...
            >
              {this.state.listingCategories.gearSubSubcategory[this.state.activeGearSubcategories].map(
                (category, idx) => (
                  <Select.Option key={idx} value={category}>
                    {category}
                  </Select.Option>
