  ...
  return (
    <div className="FAQContainer">
      ...
      <ul>
        ...
        <li>
          If it is cancelled anytime in the 48 hours before the start of the rental, you may be subject to pay the full
          rental price.
        </li>
      </ul>
      <p>
      ...
      <p>
        <strong>Top quality listings</strong> - Improving the image quality and description of the items can drastically
        improve your chances of a rental. Listings with original photos earn 2.4x as much as those with stock images.
      </p>
      <p>
        <strong>Promoting your brand</strong> - Our algorithm tracks lender visibility both on and off platform. Improve
        this by sharing your listings and lender profile page via social media and instant messengers.
      </p>
      <p>
      ...
      <p>
        <strong>Pricing Is Key</strong> : Put simply, lower prices generate more rentals and more money in the long run.
        Be reasonable when choosing the price at which to list your item. Have a browse, see what the going rate is for
        similar items and use that as a benchmark.
      </p>
      <p>
      ...
      <p>
        <strong>Leave Reviews</strong> : LensHood users are more likely to rent from a product with good reviews. If you
        have had a pleasant experience with the product – leave it a review to let others know and they'll most likely
        return the favour.
      </p>
      <h3>How should I set the price for my camera?</h3>
      <p>
        Feel free to use our suggested daily/weekly rental price as a benchmark. You could also have a look to see what
        similar items are currently renting for. In addition, if you're looking to rent for a longer period of time, we
        suggest lowering the daily price further.
      </p>
      <p>
      ...
      <p>
        E.g If you've picked up the item at 10AM, then 10AM the next morning would be the time to handover the item back
        to the lender.
      </p>
      ...
      <p>
        ...
        you to resolve the matter. You definitely want to get in touch with the lender and let them know what happened;
        also take photographs of the damage.
      </p>
