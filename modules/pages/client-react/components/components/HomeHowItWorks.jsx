...
const ForBorrowers = [
  ...
  },
  {
    head: "Use And Return",
    text:
      "Happy clicking! Our hustler will meet you once the rental period is over to collect the gear."
  }
];
...
const ForLenders = [
  {
    head: "List",
    text:
      "List your equipment for rental and we will call you to schedule your verification."
  },
  {
    head: "Verification",
  ...
  },
  {
    head: "Return",
    text:
      "As soon as the order is done, our hustlers will return your gear back to you"
  }
];
...
const HomeHowItWorks = ({ t }) => {
  return (
    <div className="home-how-it-works-container layout-counter-margin layout-padding">
      <Row gutter={10} align="middle" type="flex" style={{ height: "700px" }}>
        <Col xs={24} span={12} md={12}>
          <div className="home-steps-picture" style={{ background: "red" }} />
        </Col>
        <Col xs={24} span={12} md={12}>
