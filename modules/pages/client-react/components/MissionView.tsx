  ...
  return (
    <div className="MissionContainer">
      <section>
        ...
        <p>
          Our vision is to build a sustainable future where people collaboratively consume various equipments, resources
          and thereby making anything affordable and accessible.
        </p>
