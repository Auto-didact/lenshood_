    ...
    >
      ...
      >
        ...
        <Tabs
          defaultActiveKey="2"
          size="large"
          tabBarStyle={{ maxWidth: '1000px', display: 'flex', justifyContent: 'center', color: '#111' }}
        >
          <TabPane tab="For Renters" key="1">
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
              ...
              >
                <div>
                  <h1 style={{ fontWeight: '600', fontSize: '50px', margin: '0 0 0 0' }}>1. Search</h1>
                  <h2 style={{ margin: '0 0 0 0', padding: '0 0 10px 40px', maxWidth: '500px', fontSize: '30px' }}>
              ...
              >
                <div>
                  <h1 style={{ fontWeight: '600', fontSize: '50px', margin: '0 0 0 0' }}>2. Book</h1>
                  <h2 style={{ margin: '0 0 0 0', padding: '0 0 10px 40px', maxWidth: '500px', fontSize: '30px' }}>
              ...
              >
                <div>
                  <h1 style={{ fontWeight: '600', fontSize: '50px', margin: '0 0 0 0' }}>3. ID Proof</h1>
                  <h2
                    style={{
                      margin: '0 0 0 0',
          ...
          <TabPane tab="For Lenders" key="2">
            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
              ...
              >
                <div>
                  <h1 style={{ fontWeight: '600', fontSize: '50px', margin: '0 0 0 0' }}>1. List</h1>
                  <h2 style={{ margin: '0 0 0 0', padding: '0 0 10px 40px', maxWidth: '500px', fontSize: '30px' }}>
              ...
              >
                <div>
                  <h1 style={{ fontWeight: '600', fontSize: '50px', margin: '0 0 0 0' }}>2. Verification</h1>
                  <h2
                    style={{
                      margin: '0 0 0 0',
                      padding: '0 0 10px 40px',
              ...
              >
                <div>
                  <h1 style={{ fontWeight: '600', fontSize: '50px', margin: '0 0 0 0' }}>3. Notification</h1>
                  <h2
                    style={{
                      margin: '0 0 0 0',
                      padding: '0 0 10px 40px',
              ...
              >
                <div>
                  <h1 style={{ fontWeight: '600', fontSize: '50px', margin: '0 0 0 0' }}>4. Earn</h1>
                  <h2 style={{ margin: '0 0 0 0', padding: '0 0 10px 40px', maxWidth: '500px', fontSize: '30px' }}>
              ...
              >
                <div>
                  <h1 style={{ fontWeight: '600', fontSize: '50px', margin: '0 0 0 0' }}>5. Return</h1>
                  <h2
                    style={{
                      margin: '0 0 0 0',
                      padding: '0 0 10px 40px',
