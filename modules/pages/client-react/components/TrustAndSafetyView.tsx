  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          LensHood Community is<span style={{ color: '#23b195' }}> 100% invite based</span> - Hence every user is
          referred by a trusted person from our community. We at LensHood have listed a few tips to make the most of
        ...
        >
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', textAlign: 'left', padding: '0 0 0 4px', maxWidth: '500px' }}>
        ...
        >
          ...
          <div>
            <h1 style={{ fontWeight: '600', fontSize: '37px', margin: '0 0 0 0', color: '#767676', textAlign: 'left' }}>
              Government ID
            </h1>
            <h2
              style={{
        ...
        <div style={{ background: '#ddd', width: '100%', height: '1.5px', marginTop: '150px' }} />
        ...
        <div style={{ maxWidth: '1200px' }}>
          <h1
            style={{ fontWeight: '600', fontSize: '37px', margin: '50px 0 0 0', color: '#767676', textAlign: 'left' }}
          >
            In case of Theft
          </h1>

          <ul style={{ listStyle: 'none', textAlign: 'left', padding: '0 0 0 4px' }}>
            <li style={{ fontSize: '30px' }}>
              <span>
          ...
          <ul style={{ listStyle: 'none', textAlign: 'left', padding: '0 0 0 4px', fontWeight: '600' }}>
          ...
          <h3 style={{ color: '#767676', textAlign: 'left', fontSize: '25px', margin: '-15px 0 0 32px' }}>
            Pay just <strong>1% of your equipment</strong> worth as monthly insurance of the device/equipment.
          </h3>
          <h3 style={{ color: '#767676', textAlign: 'left', fontSize: '25px', margin: '-5px 0 0 32px' }}>
