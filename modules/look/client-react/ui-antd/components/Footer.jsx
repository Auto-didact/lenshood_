...
export default class Footer extends React.Component {
  ...
  toggle=function(det){
if(det==1)
  this.setState((state)=>{return{show1:!state.show1}});
  if(det==2)
  this.setState((state)=>{return{show2:!state.show2}});
  if(det==3)
  this.setState((state)=>{return{show3:!state.show3}});
  if(det==4)
  this.setState((state)=>{return{show4:!state.show4}});
  }
...
<Container className="no-print" align="center">
        ...
        <div style={{display:'flex',flexDirection:'column'}}>
          <div>
                <h3  onClick={()=>this.toggle(1)}>About Lenshood<img src={require('../images/dropdown.png')} width="20px" height="20px" /></h3>
          ...
          <div>
          <h3  onClick={()=>this.toggle(2)}>How It Works<img src={require('../images/dropdown.png')} width="20px" height="20px" /></h3>
          ...
          <div>
          <h3  onClick={()=>this.toggle(3)}>Keep In Touch<img src={require('../images/dropdown.png')} width="20px" height="20px" /></h3>
          ...
          <div>
          <h3 onClick={()=>this.toggle(4)}>Follow Us<img src={require('../images/dropdown.png')} width="20px" height="20px" /></h3>
